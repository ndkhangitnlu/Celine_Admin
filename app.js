...
var products = {
    manStyle: {
        // Đặt tên là aothunnam1,2,3 để khi dùng phương thức sellProduct gọi lại đúng id
        aothunnam1: new Products("Thời trang nam", "aothunnam1", 99000, "Black", "Yes", "S/M/L"),
        aothunnam2: new Products("Thời trang nam", "aothunnam2", 499000, "Black", "No", "M/L"),
        aothunnam3: new Products("Thời trang nam", "aothunnam3", 199000, "Light-White", "Yes", "M/L/XL"),
        quannam1: new Products("Thời trang nam", "quannam1", 125000, "Black and White", "No", "S/M/L"),
        quannam2: new Products("Thời trang nam", "quannam2", 129000, "Black", "Yes", "M/L/XL/XXL"),
        quannam3: new Products("Thời trang nam", "quannam3", 150000, "Black/White", "Yes", "L/XL/XXL"),
    },
    womenStyle: {
        aothunnu1: new Products("Thời trang nữ", "aothunnu1", 159000, "Grey/Light-Red", "Yes", "S/M/L"),
        aothunnu2: new Products("Thời trang nữ", "aothunnu2", 90000, "Blue/Off-White", "No", "Free"),
        aothunnu3: new Products("Thời trang nữ", "aothunnu3", 75000, "Yellow", "Yes", "M/L"),
        quannu1: new Products("Thời trang nữ", "quannu1", 300000, "Black", "Yes", "S/M"),
        quannu2: new Products("Thời trang nữ", "quannu2", 50000, "Black/Blue/Grey/Pink", "No", "S/M/L"),
        quannu3: new Products("Thời trang nữ", "quannu3", 499000, "Pink", "Yes", "Free"),
    },
    accessory: {
        phukien1: new Products("Phụ kiện", "phukien1", 267000, "Yellow White", "Yes", "L"),
        phukien2: new Products("Phụ kiện", "phukien2", 220000, "Black-Pink", "No", "M"),
        phukien3: new Products("Phụ kiện", "phukien3", 450000, "White", "Yes", "Free"),
        phukien4: new Products("Phụ kiện", "phukien4", 135000, "Light-Pink", "Yes", "S/M/L"),
        phukien5: new Products("Phụ kiện", "phukien5", 110000, "Silver", "No", "Free"),
        phukien6: new Products("Phụ kiện", "phukien6", 290000, "Blue Jeans", "Yes", "L")
    },
}
function filter() {
    ...
    if (userInput != "" && userInput != undefined && userInput != " " && userInput != null) {
        ...
        if (flag != true) {
            ...
            document.getElementById("topButton").style.display = 'none';
            document.getElementById("displaye").innerText = "KHÔNG TÌM THẤY!";
            document.getElementById("homeButton").style.display = 'block';
        }
    }
}
...
function details(productName, srcc) {
    ...
    for (var key in products) {
        for (var key2 in products[key]) {
            if (name === key2) {
                swal({
                    title: "Tên : " + products[key][key2].name,
                    text: "Phân loại : " + "( " + products[key][key2].category + " )  "
                        + " --- Màu sẵc : ( " + products[key][key2].color + " ) "
                        + " --- Sẵn kho  : ( " + products[key][key2].stock + " ) "
                        + " --- Size : ( " + products[key][key2].sizes + " ) "
                        + " --- Giá : (" + products[key][key2].price + " ) ",
                    textColor: "red",
                    imageUrl: src,
                    imageWidth: 300,
                    imageHeight: 250,
                ...
                swal({
                    title: "Tên : " + products[key][key2].name,
                    text: "Phân loại : " + "( " + products[key][key2].category + " )  "
                        + " --- Màu sắc : ( " + products[key][key2].color + " ) "
                        + " --- Sẵn kho  : ( " + products[key][key2].stock + " ) "
                        + " --- Size : ( " + products[key][key2].sizes + " ) "
                        + " --- Giá : ( " + products[key][key2].price + " ) ",
                    textColor: "red",
                ...
                for (var key2 in products[key]) {
                    if (nameProduct === key2) {
                        ...
                        swal({
                            type: "success",
                            title: "Đã bán!",
                            text: "Sản phẩm " + products[key][key2].name + " đã được bán. Tổng tiền : " + quantity + "X" + products[key][key2].price + "=" + quantity * products[key][key2].price + "." + "Cảm ơn!",
                        })
                        var soldd = {
                            date: DATE,
                            name: NAME,
...
function remove(id) {
    ...
    swal({
        type: "question",
        title: "Bạn có chắc muốn xóa hay không?",
        text: "Nếu xóa bạn sẽ không thể truy cập vào sản phẩm này nữa.",
...
function insertData(id) {
    ...
    if (id === "manStyle") {
        ...
        var editBtnText = document.createTextNode(" THÊM");
        ...
        var deleteBtnText = document.createTextNode(" XÓA");
    ...
    if (id === "womenStyle") {
        ...
        // muốn đổi ảnh liên tục thì thay tên ảnh bằng biến counterForFoot
        var p = document.createElement("p");
        p.setAttribute("class", "proInfoN");
        p.setAttribute("id", objName + "1");
